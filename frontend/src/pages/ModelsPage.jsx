...
const MODELS = [
  {
    ...
    desc: 'The core visual workhorse. Employs advanced auto-attention mechanisms to detect subtle blending artifacts, noise inconsistencies, and structural anomalies at the pixel level.',
    acc: '92.4%',
    param: '19M',
  },
  {
    type: 'Audio / Voice',
    title: 'WavLM & Wav2Lip',
    desc: 'Audio-visual synchronization and raw waveform analysis. Detects AI voice cloning and lip-sync mismatch by analyzing phonetic spectrograms against mouth movements.',
    acc: '89.1%',
    param: '316M',
  },
  {
    type: 'NLP / Linguistic',
    title: 'XLM-RoBERTa',
    desc: 'Fine-tuned to detect machine-generated text and propaganda across 11 languages, including Hindi, Tamil, and Bengali. Analyzes perplexity and semantic bursts.',
    acc: '94.2%',
    param: '278M',
  },
  {
    ...
    desc: 'The multimodal reasoning engine. Takes raw signals from all specialist models (heatmaps, waveforms, confidence scores) and synthesizes them into plain-English journalistic verdicts.',
    acc: 'N/A',
    param: 'API',
  }
];
