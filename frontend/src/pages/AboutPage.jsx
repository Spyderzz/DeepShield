      ...
      <section className="page-shell about-shell">
        <div className="page-head">
          ...
          <p className="sub" style={{ maxWidth: 640 }}>
            DeepShield is a forensic AI system built for journalists, fact-checkers, and everyday readers.
            We don't chase virality. We ship evidence — layered, open, and auditable.
          </p>
        </div>
        ...
        <div className="about-wrap">
          ...
          <div className="about-cta">
            ...
            <div style={{ display: 'flex', gap: 12, justifyContent: 'center', marginTop: 28 }}>
              <a onClick={() => navigate('/analyze')} className="btn btn-primary btn-lg btn-shiny" style={{ textDecoration: 'none', cursor: 'pointer' }}>Try DeepShield →</a>
              <a className="btn btn-glass btn-lg" style={{ textDecoration: 'none', cursor: 'pointer' }}>Open roles ↗</a>
            </div>
          </div>
        </div>
      </section>
